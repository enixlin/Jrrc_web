...
require_once ('../jrrc_web/public/jpgraph/src/jpgraph.php');
require_once ('../jrrc_web/public/jpgraph/src/jpgraph_bar.php');

$datay=array(12,26,9,17,31,12,26,9,17,31,12,26,9,17,31,12,26,9,17,31);
		// Create the graph.
		// One minute timeout for the cached image
		// INLINE_NO means don't stream it back to the browser.
		$graph = new Graph(510,250,'auto');
