...
<table border=1 width="100%" id='table_settlement'>
	...
	<tr>
		...
		<td class='thead ,width' colspan=3>储蓄存款日均增量</br>( <?php echo ($date_cxrj[0]['date']); ?>)</td>
...
<?php if(is_array($report)): $n = 0; $__LIST__ = $report;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($n % 2 );++$n; if($vo['Head_office'] == '08100' ): ?><tr>
			...
			<?php else: ?><td align='right'><?php echo (number_format($vo["task_amount_js"])); ?></td><?php endif; ?>
			<td align='right'><?php echo (number_format($vo["amount_js"],2)); ?></td>
			<?php if($vo['js_complete_rate'] == null ): ?><td>&nbsp;</td>
			<?php else: ?><td align='right'><?php echo (number_format($vo["js_complete_rate"],2)); ?></td><?php endif; ?>
			<td align='right'><?php echo (number_format($vo["season_amount_js"],2)); ?></td>
		
			<?php if($vo['task_amount_jsh'] == null ): ?><td>&nbsp;</td>
			<?php else: ?><td align='right'><?php echo (number_format($vo["task_amount_jsh"])); ?></td><?php endif; ?>
			<td align='right'><?php echo (number_format($vo["amount_jsh"],2)); ?></td>
			<?php if($vo['jsh_complete_rate'] == null ): ?><td>&nbsp;</td>
			<?php else: ?><td align='right'><?php echo (number_format($vo["jsh_complete_rate"],2)); ?></td><?php endif; ?>
			<td align='right'><?php echo (number_format($vo["season_amount_jsh"],2)); ?></td>
			
			<?php if($vo['task_amount_client'] == null ): ?><td>&nbsp;</td>
			<?php else: ?><td align='right'><?php echo (number_format($vo["task_amount_client"])); ?></td><?php endif; ?>
			<td align='right'><?php echo (number_format($vo["amount_client"])); ?></td>
			<?php if($vo['client_complete_rate'] == null ): ?><td>&nbsp;</td>
			<?php else: ?><td align='right'><?php echo (number_format($vo["client_complete_rate"],2)); ?></td><?php endif; ?>
			
			<?php if($vo['task_amount_cx'] == null ): ?><td>&nbsp;</td>
			<?php else: ?><td align='right'><?php echo (number_format($vo["task_amount_cx"])); ?></td><?php endif; ?>
			<td align='right'><?php echo (number_format($vo["amount_cx"],2)); ?></td>
			<?php if($vo['cx_complete_rate'] == null ): ?><td>&nbsp;</td>
			<?php else: ?><td align='right'><?php echo (number_format($vo["cx_complete_rate"],2)); ?></td><?php endif; ?>
	...
	<tr class='font-aril sub_total'>
		...
		<td align="right" class='sub_total'><?php echo (number_format($branch_sum['task_amount_jsh_sum'],2)); ?></td>
		<td align="right" class='sub_total'><?php echo (number_format($branch_sum['amount_jsh_sum'],2)); ?></td>
		<td align="right" class='sub_total'><?php echo (number_format($branch_sum['jsh_complete_rate_sum'],2)); ?></td>
		<td align="right" class='sub_total'><?php echo (number_format($branch_sum['amount_jsh_season_sum'],2)); ?></td>
		
		<td align="right" class='sub_total'><?php echo (number_format($branch_sum['task_amount_client_sum'])); ?></td>
		<td align="right" class='sub_total'><?php echo (number_format($branch_sum['amount_client_sum'])); ?></td>
		<td align="right" class='sub_total'><?php echo (number_format($branch_sum['client_complete_rate_sum'],2)); ?></td>
		...
		<?php if(is_array($report)): $n = 0; $__LIST__ = $report;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($n % 2 );++$n; if($vo['Head_office'] == '08101' ): ?><tr>
			...
			<?php if($vo["br_name"] == 国际业务部): ?>代理联社业务 
			<?php else: echo (str_replace('本部','',$vo["br_name"])); endif; ?>
			</td>
			<?php if($vo['task_amount_js'] == null ): ?><td>&nbsp;</td>
			<?php else: ?><td align='right'><?php echo (number_format($vo["task_amount_js"])); ?></td><?php endif; ?>
			<td align='right'><?php echo (number_format($vo["amount_js"],2)); ?></td>
	...
	<tr class='font-aril sub_total'>
		...
		<td align="right" class='sub_total'><?php echo (number_format($department_sum['task_amount_jsh_sum'],2)); ?></td>
		<td align="right" class='sub_total'><?php echo (number_format($department_sum['amount_jsh_sum'],2)); ?></td>
		<td align="right" class='sub_total'><?php echo (number_format($department_sum['jsh_complete_rate_sum'],2)); ?></td>
		<td align="right" class='sub_total'><?php echo (number_format($department_sum['amount_jsh_season_sum'],2)); ?></td>
		
		<td align="right" class='sub_total'><?php echo (number_format($department_sum['task_amount_client_sum'])); ?></td>
		<td align="right" class='sub_total'><?php echo (number_format($department_sum['amount_client_sum'])); ?></td>
		<td align="right" class='sub_total'><?php echo (number_format($department_sum['client_complete_rate_sum'],2)); ?></td>
	...
	<tr class='font-aril sub_total'>
		...
		<td align="right" class='total'><?php echo (number_format($total['task_amount_js_season'],2)); ?></td>
		...
		<td align="right" class='total'><?php echo (number_format($total['task_amount_jsh_season'],2)); ?></td>
		<td align="right" class='total'><?php echo (number_format($total['amount_jsh_sum'],2)); ?></td>
		<td align="right" class='total'><?php echo (number_format($total['jsh_complete_rate_sum'],2)); ?></td>
		<td align="right" class='total'><?php echo (number_format($total['amount_jsh_season_sum'],2)); ?></td>
		
		<td align="right" class='total'><?php echo (number_format($total['task_amount_client_season'])); ?></td>
		<td align="right" class='total'><?php echo (number_format($total['amount_client_sum'])); ?></td>
		<td align="right" class='total'><?php echo (number_format($total['client_complete_rate_sum'],2)); ?></td>
		
		
		<td align="right" class='total'><?php echo (number_format($total['task_amount_cx_season'],2)); ?></td>
...
$("#table_settlement td").bind('click', function(evgl) {
	...
	if(br_id!=''){
		if(br_id=='08128' || br_id=='08130' || br_id=='08132' || br_id=='08108'){
			url='/jrrc_web/home/report1/show_Unit_Report_Month';
		}else{
			url='/jrrc_web/home/report1/show_Unit_Report_Month';
		}
