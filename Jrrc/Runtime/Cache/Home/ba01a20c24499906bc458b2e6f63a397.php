	...
	$(function(){
		...
		$("#btn_submit").bind('click',function(){
			...
			if($("#report_type").val()==1){
				url='/Jrrc_web/home/report2016/show_Unit_Report';
			}
			if($("#report_type").val()==2){
				url='/Jrrc_web/home/report2016/show_Client_Report';
			}
			if($("#report_type").val()==3){
				url='/Jrrc_web/home/report2016/show_All_Report_Month';
			}
			if($("#report_type").val()==4){
				url='/Jrrc_web/home/report2016/show_Client_first_date';
			}
		...
		$("#btn_export").bind('click',function(){
			...
			var url1='';
			if($("#report_type").val()==1){
				url='/Jrrc_web/home/report2016/Export_Unit_Excel';
				url1='/Jrrc_web/home/report2016/show_Unit_Report';
			}
			if($("#report_type").val()==2){
				url='/Jrrc_web/home/report2016/Export_Client_Excel';
				url1='/Jrrc_web/home/report2016/show_Client_Report';
			}
			if($("#report_type").val()==3){
				return;
			}
			...
			if($("#report_type").val()==4){
				url='/Jrrc_web/home/report2016/Export_Client_first_date';
				url1='/Jrrc_web/home/report2016/show_Client_first_date';
			}
