...
&nbsp;
<img src='/jrrc_web/home/Report1/Client_Barplot/client_id/<?php echo ($client_id); ?>/start/<?php echo ($start); ?>/end/<?php echo ($end); ?>/type/<?php echo ($type); ?>'  alt=""  id='chart_month_list'/>
&nbsp;
<img src='/jrrc_web/home/Report1/Client_Type_Pie/client_id/<?php echo ($client_id); ?>/start/<?php echo ($start); ?>/end/<?php echo ($end); ?>/type/<?php echo ($type); ?>'  alt=""  id='chart_month_list'/>
