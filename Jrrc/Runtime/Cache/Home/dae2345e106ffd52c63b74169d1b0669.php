...
&nbsp;
<img src='/jrrc_web/home/report2016/Unit_Barplot/unit/<?php echo ($br_id); ?>/start/<?php echo ($start); ?>/end/<?php echo ($end); ?>/type/<?php echo ($type); ?>'  alt=""  id='chart_month_list'/>
&nbsp;
<img src='/jrrc_web/home/report2016/Unit_Type_Pie/unit/<?php echo ($br_id); ?>/start/<?php echo ($start); ?>/end/<?php echo ($end); ?>/type/<?php echo ($type); ?>'  alt=""  id='chart_month_list'/>
