...
&nbsp;
<img src='/jrrc_web/home/Report2016/Client_Barplot_compare/client_id/<?php echo ($client_id); ?>/start/<?php echo ($start); ?>/end/<?php echo ($end); ?>/type/<?php echo ($type); ?>'  alt=""  id='chart_month_list'/>
&nbsp;
<img src='/jrrc_web/home/Report2016/Client_Type_Pie/client_id/<?php echo ($client_id); ?>/start/<?php echo ($start); ?>/end/<?php echo ($end); ?>/type/<?php echo ($type); ?>'  alt=""  id='chart_month_list'/>
